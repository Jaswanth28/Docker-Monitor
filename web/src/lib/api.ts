...
export interface Stats { id: string; cpu_percent: number; mem_usage: number; mem_limit: number; mem_percent: number; net_rx: number; net_tx: number }
...
export interface HostSample { t: number; cpu_percent: number; mem_total: number; mem_used: number; mem_percent: number; load: number[] }
export interface TopEntry extends Sample { id: string; name: string; project: string | null; service: string | null; image: string }
export interface StackUsage { name: string; cpu_percent: number; mem_usage: number; containers: number; net_rx_rate: number; net_tx_rate: number }
...
export interface Overview {
  ...
  containers: TopEntry[]
  stacks: StackUsage[]
  totals: { containers_sampled: number; cpu_percent: number; mem_usage: number }
